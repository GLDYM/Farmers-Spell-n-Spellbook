...
public class ModBlocks {
    ...
    // 橱柜
    public static final RegistryObject<CabinetBlock> WISEWOOD_CABINET = registerBlock("wisewood_cabinet",
    ...
    public static final RegistryObject<AlchemistPotBlock> ALCHEMIST_POT = registerBlock("alchemist_pot",
            () -> new AlchemistPotBlock(BlockBehaviour.Properties.of()
                    ...
                    .strength(3.0F,6.0F)));
    //紫晶甜菜 
    public static final RegistryObject<AmethystBeetrootBlock> AMETHYST_BEETROOT = BLOCKS.register("amethyst_beetroot", AmethystBeetrootBlock::new);
    // 红丝绒蛋糕
    ...
    public static final RegistryObject<Block> EMBER_BLOCK = registerBlock("ember_block",
            () -> new Block(BlockBehaviour.Properties.of()
                    ...
                    .strength(3.0F, 6.0F))); 
    // 雕文残焰块                
    public static final RegistryObject<Block> GLYPHED_EMBER_BLOCK = registerBlock("glyphed_ember_block",
        () -> new Block(BlockBehaviour.Properties.of()
                .mapColor(MapColor.COLOR_GRAY)
                .sound(SoundType.STONE)
                .strength(3.0F, 6.0F)));
    ...
    public static final RegistryObject<IronBarsBlock> EMBER_BARS = registerBlock("ember_bars",
            () -> new IronBarsBlock(BlockBehaviour.Properties.of()
                    ...
                    .noOcclusion()));
    // 磨制残焰块
    public static final RegistryObject<Block> POLISHED_EMBER_BLOCK = registerBlock("polished_ember_block",
            () -> new Block(BlockBehaviour.Properties.of()
                    .mapColor(MapColor.COLOR_GRAY)
                    .sound(SoundType.STONE)
                    .strength(3.0F, 6.0F)));
    // 凿制花纹残焰块
    public static final RegistryObject<Block> CHISELED_EMBER_BLOCK = registerBlock("chiseled_ember_block",
            () -> new Block(BlockBehaviour.Properties.of()
                    .mapColor(MapColor.COLOR_GRAY)
                    .sound(SoundType.STONE)
                    .strength(3.0F, 6.0F)));
    ...
    private static <T extends Block> void registerPlaceableBlockItem(String name, RegistryObject<T> block) {
        ModItems.ITEMS.register(name, () -> new PlaceableItem(block.get(),
                new Item.Properties()));
    }
