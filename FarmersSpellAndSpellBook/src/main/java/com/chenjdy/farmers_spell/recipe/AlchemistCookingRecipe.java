    ...
    public static class AlchemistRecipeSerializer implements RecipeSerializer<AlchemistCookingRecipe> {
        ...
        public AlchemistCookingRecipe fromJson(ResourceLocation recipeId, JsonObject json) {
            ...
            for (int i = 0; i < GsonHelper.getAsJsonArray(json, "ingredients").size(); ++i) {
                nonnulllist.add(Ingredient.fromJson(GsonHelper.getAsJsonArray(json, "ingredients").get(i)));
            }
        ...
        @Override
        public AlchemistCookingRecipe fromNetwork(ResourceLocation recipeId, FriendlyByteBuf buf) {
        ...
        @Override
        public void toNetwork(FriendlyByteBuf buf, AlchemistCookingRecipe recipe) {
            ...
            buf.writeItem(recipe.getOutputContainer());
