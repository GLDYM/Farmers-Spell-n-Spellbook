...
public class ModCreativeModeTabs {
    ...
    public static void register(IEventBus eventBus) {
        ...
        .add(ModItems.BUTTER_POTATO).add(ModItems.AMETHYST_BURGER).add(ModItems.CERIC_CROSS_BUN).add(ModItems.SALMON_BURGER).add(ModItems.ICEBREAKER_BREAD).add(ModItems.CINDEROUS_HAM).add(ModItems.HOGSKIN_SAUSAGE).add(ModItems.WINE_BEEF_STEW).add(ModItems.WINE_RICE).add(ModItems.CINDEROUS_HOTPOT).add(ModItems.BOWL_OF_GLUTTON_HOTCHPOTCH).add(ModItems.BOWL_OF_PUMPKIN_SOUP).add(ModItems.BOWL_OF_SAINGEZI_CHICKEN).add(ModItems.BOWL_OF_DRAGON_SKIN_ASPIC).add(ModItems.DRAGON_PIZZA).add(ModItems.DRAGONSKIN_ASPIC).addBlock(ModBlocks.GLUTTON_HOTCHPOTCH).addBlock(ModBlocks.PUMPKIN_SOUP).addBlock(ModBlocks.SAINGEZI_CHICKEN));
        // 饮品 - 所有饮料
