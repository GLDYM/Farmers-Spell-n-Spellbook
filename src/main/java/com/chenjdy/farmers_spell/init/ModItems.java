...
public class ModItems {
    ...
    public static final DeferredHolder<Item, Item> CHERRY_SPOON = ITEMS.register("cherry_spoon", CherrySpoon::new);
    public static final DeferredHolder<Item, Item> IRIS_FORK = ITEMS.register("iris_fork", IrisFork::new);
