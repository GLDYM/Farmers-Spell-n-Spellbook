...
public class SpellBookCurioRender implements ICurioRenderer {
    ...
    public <T extends LivingEntity, M extends EntityModel<T>> void render(
        ...
        if (renderLayerParent.getModel() instanceof HumanoidModel<?>) {
            ...
            poseStack.translate(
                    (slotContext.entity() != null && !slotContext.entity().getItemBySlot(EquipmentSlot.CHEST).isEmpty() ? -5.5 : -4.5) * .0625f,
                    9 * .0625f,
                    0
            );
