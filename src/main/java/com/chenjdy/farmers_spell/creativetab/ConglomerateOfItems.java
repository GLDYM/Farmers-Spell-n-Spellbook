...
public class ConglomerateOfItems {
    ...
    public void resolveStacks(RegistryAccess registryAccess) {
        ...
        for (Object o : conglomerate) {
            ...
            if (o instanceof DeferredHolder<?, ?> i) {
    ...
    public ConglomerateOfItems add(DeferredHolder<Item, ? extends Item> registryObjectOfItem) {
        conglomerate.add(registryObjectOfItem);
        return this;
    }

    public ConglomerateOfItems addBlock(DeferredHolder<Block, ? extends Block> registryObjectOfBlock) {
