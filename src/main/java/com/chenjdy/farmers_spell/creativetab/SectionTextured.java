...
public class SectionTextured extends AbstractSectionWithTitle<SectionTextured> {
    ...
    public void render(GuiGraphics guiGraphics, Font font, int topLeftX, int topLeftY) {
        guiGraphics.blit(texture, topLeftX + textureOffsetX, topLeftY + textureOffsetY, 0, 0, horizontalSize, verticalSize, horizontalSize, verticalSize);
    ...
    public SectionTextured(ResourceLocation id, Component title, ResourceLocation texture, int textColor, boolean textShadow, boolean collapsible, ConglomerateOfItems items) {
        super(id);
        this.title = title;
    ...
    public static SectionTextured of(ResourceLocation id, Component title, int textColor, boolean textShadow, boolean collapsible, ConglomerateOfItems items) {
        return new SectionTextured(id, title, ResourceLocation.fromNamespaceAndPath(id.getNamespace(), "textures/gui/fancy_tab_section/" + id.getPath() + ".png"), textColor, textShadow, collapsible, items);
    }
