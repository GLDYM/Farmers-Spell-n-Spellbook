...
public class GrowKnife extends MagicSwordItem {
    ...
    public InteractionResult useOn(UseOnContext context) {
        ...
        if (harvestCount > 0) {
            serverLevel.playSound(null, player.getX(), player.getY(), player.getZ(), SoundEvents.PLAYER_ATTACK_SWEEP, player.getSoundSource(), 1F, 1F);
            player.sweepAttack();
            heldStack.hurtAndBreak(harvestCount, player, EquipmentSlot.MAINHAND);
