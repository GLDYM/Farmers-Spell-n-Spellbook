...
public class ModFoods {
    ...
    // 水煮肉片
    public static final FoodProperties SICHUAN_BOILED_PORK_SLICES = new FoodProperties.Builder()
            .nutrition(13).saturationMod(0.61f)
            .effect(() -> new MobEffectInstance(FIRE_RESISTANCE, 2 * 60 * 20), 1.0F)
            .alwaysEat().build();

    // 水煮鱼
    public static final FoodProperties SICHUAN_BOILED_FISH = new FoodProperties.Builder()
            .nutrition(13).saturationMod(0.61f)
            .effect(() -> new MobEffectInstance(FIRE_RESISTANCE, 2 * 60 * 20), 1.0F)
            .alwaysEat().build();
